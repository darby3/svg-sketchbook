(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const container = document.querySelector('#plaid-with-other-things-2');
    ...
    Line.prototype.draw = function () {
      ...
      newLine.setAttributeNS(null, 'x1', this.x1);
      newLine.setAttributeNS(null, 'y1', this.y1);
      newLine.setAttributeNS(null, 'x2', this.x2);
      newLine.setAttributeNS(null, 'y2', this.y2);
      newLine.classList.add('fun-line');

      svgOutput.appendChild(newLine);
    }
    ...
    xCoords.forEach((x) => lines.push(new Line(x, 0, x, svgAttrs.height)));
    yCoords.forEach((y) => lines.push(new Line(0, y, svgAttrs.width, y)));
    ...
    ellipse.setAttributeNS(null, 'cx', svgAttrs.width / 2);
    ellipse.setAttributeNS(null, 'cy', svgAttrs.height / 2);
    ellipse.setAttributeNS(null, 'rx', svgAttrs.width / 2);
    ellipse.setAttributeNS(null, 'ry', svgAttrs.height / 2);
    ellipse.setAttributeNS(null, 'class', 'ellipseThing');

    svgOutput.appendChild(ellipse);
  });
})();
