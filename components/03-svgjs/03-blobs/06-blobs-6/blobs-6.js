...
console.log("blobs-6 active");

const draw = SVG('#blobs-6-svg');
...
for (let i = 0; i < numBlobs; i++) {
  ...
  let circleC = circleA.clone().transform({
    scale: 0.95,
  })

  let circleD = circleB.clone().transform({
    scale: 0.95,
  })

  circlesGroup.add(circleC);
  circlesGroup.add(circleD);
