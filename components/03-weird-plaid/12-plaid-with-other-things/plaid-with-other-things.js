(function () {
  document.addEventListener('DOMContentLoaded', function () {
    console.log("plaid-with-other-things active");

    const container = document.querySelector('#plaid-with-other-things');
    ...
    //     circle.setAttributeNS(null, 'cx', xCoords[i]);
    //     circle.setAttributeNS(null, 'cy', yCoords[j]);
    //     circle.setAttributeNS(null, 'r', 25);
    //     circle.setAttributeNS(null, 'class', 'circleThing');
    //
